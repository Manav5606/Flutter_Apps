...
class _BillSplitterState extends State<BillSplitter> {
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text("\$ ${(calculateTotalTip(
                            _billAmount,
                            _personCounter,
                            _tipPercentage)).toStringAsFixed(2)}", style: TextStyle(
                          color: Colors.purple,
                          fontWeight: FontWeight.bold,
                          fontSize: 17.0,
                        ),
  ...
  calculateTotalPerPerson(double billAmount, int splitBy, int tipPercenatge){

    var totalPerPerson = (calculateTotalTip(billAmount, splitBy, tipPercenatge)+ billAmount) / splitBy;
